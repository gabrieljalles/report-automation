...
def adicional_insalubridade20(data_final):
    verba = '0155'
    ...
    if data_final_formatada.insert(2, "-") is None:
        ...
        nome_relatorio = f'Verba155 (AD de insalubridade20%){data_final_formatada}'
        grh.baixar_relatorio(nome_relatorio)
        pyautogui.hotkey('alt', 'f4')
        origem = fr'C:\..arelatoriotemporario\{nome_relatorio}.xlsx'
        destino = fr'\\172.22.1.26\Users\DA\Ger Adm\Sup TI CDOC\N TI\powerbi\GRH\BI 2.0\Verbas\Adicional Insalubridade 20%\{nome_relatorio}.xlsx'
        shutil.move(origem, destino)
        sleep(4)
        grh.limpa_arq(nome_relatorio)


adicional_insalubridade20('032022')